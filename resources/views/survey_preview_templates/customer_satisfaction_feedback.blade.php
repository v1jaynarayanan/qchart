...
@section('content')
     ...
     @include('survey_preview_templates.page_header',array('name' => 'CUSTOMERS SATISFACTION'))
...
@include('survey_preview_templates.css',array('link' => 'customer-satisfaction-feedback'))
